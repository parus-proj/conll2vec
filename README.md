...
./conll2vec -task balance -model vectors.bin -size_d 75 -a_ratio 4.0
...
# Самодиагностика.
./conll2vec -task selftest_ru -model vectors.bin -model_fmt bin -size_d 75 -size_a 25 -a_ratio 1.0 -st_yo 0
```
